 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Prango Newsletter</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('subscribers') ? 'class="active"' : '') }}>
                            <a href="{{ url ('subscribers') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Subscribers</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('lists') ? 'class="active"' : '') }}>
                            <a href="{{ url ('lists') }}"><i class="fa fa-table fa-fw"></i> Lists</a>
                        </li>
                        <li {{ (Request::is('newsletters') ? 'class="active"' : '') }}>
                            <a href="{{ url ('newsletters') }}"><i class="fa fa-edit fa-fw"></i> Newsletters</a>
                        </li>
                        <li {{ (Request::is('templates') ? 'class="active"' : '') }}>
                            <a href="{{ url ('templates') }}"><i class="fa fa-edit fa-fw"></i> Templates</a>
                        </li>
                        {{--<li >--}}
