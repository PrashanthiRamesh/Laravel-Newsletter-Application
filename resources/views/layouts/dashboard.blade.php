            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="/settings/user"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('subscribers') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('subscribers') }}">View All</a>
                                </li>
                                <li {{ (Request::is('subscribe') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('subscribe' ) }}">Add New Subscriber</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Lists<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('lists') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('lists') }}">View All</a>
                                </li>
                                <li {{ (Request::is('list/new') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('list/new' ) }}">Add New List</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Newsletters<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('newsletters') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('newsletters') }}">View All</a>
                                </li>
                                <li {{ (Request::is('newsletter/new') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('newsletter/new' ) }}">Add New Newsletter</a>
                                </li>
                                <li {{ (Request::is('sender/add') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('sender/add' ) }}">Add New Sender</a>
                                </li>
                                <li {{ (Request::is('sender/change') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('sender/change' ) }}">Change Sender</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
